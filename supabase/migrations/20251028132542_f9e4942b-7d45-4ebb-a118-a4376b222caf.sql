-- Reclassificar dados existentes com as regras DRE
...
SET 
  dre_line = CASE
    ...
    -- NÍVEL 2: Revenues + entry_type
    WHEN macro_cost_type = 'Revenues' 
    ...
    -- NÍVEL 3: Fallback por Macro Type
    WHEN macro_cost_type = 'Revenues' AND entry_type = 'credit'
      THEN 'OUTRAS_RECEITAS'
    WHEN macro_cost_type = 'Revenues' AND entry_type = 'debit'
      THEN 'OUTRAS_DEDUCOES'
    WHEN macro_cost_type = 'Costs' AND entry_type = 'debit'
      THEN 'OUTRAS_DESPESAS'
    WHEN macro_cost_type = 'Costs' AND entry_type = 'credit'
  ...
  classification_rule = CASE
    ...
    WHEN macro_cost_type = 'Revenues' AND cost_type IN ('Revenues Devices', 'Revenues Services')
    ...
    WHEN macro_cost_type = 'Revenues' AND entry_type = 'credit' THEN 'NIVEL3_REVENUES_CREDIT'
    WHEN macro_cost_type = 'Revenues' AND entry_type = 'debit' THEN 'NIVEL3_REVENUES_DEBIT'
    WHEN macro_cost_type = 'Costs' AND entry_type = 'debit' THEN 'NIVEL3_COSTS_DEBIT'
    WHEN macro_cost_type = 'Costs' AND entry_type = 'credit' THEN 'NIVEL3_COSTS_CREDIT'
    WHEN entry_type = 'credit' THEN 'NIVEL4_RESIDUAL'
    ELSE 'NIVEL4_RESIDUAL'
  END
WHERE dre_line IS NULL;